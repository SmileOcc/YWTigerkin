...
let userProvider = MoyaProvider<YWUserAPI>(requestClosure: requestTimeoutClosure, session : YWMoyaConfig.session(), plugins: [YWNetworkLoggerPlugin(verbose: true)])

public enum YWUserAPI {
