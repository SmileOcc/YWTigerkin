//
//  YWNavigationController+Extension.swift
//  YWTigerkin
//
...
func navBarStyle(_ style:NavigationBarStyle) {
        ...
        case .clear:
            ...
            if #available(iOS 13.0, *) {
                ...
                navigationBar.titleTextAttributes = attrDic
                navigationBar.shadowImage = UIImage()
                let navBgImg = UIImage.imgColor(UIColor.clear, CGSize(width: KSCREEN_WIDTH, height: kNav_Height)).withRenderingMode(.alwaysOriginal)
        ...
        case .white:
            ...
            if #available(iOS 13.0, *) {
                ...
                let navBgImg = UIImage.imgColor(UIColor.white, CGSize(width: KSCREEN_WIDTH, height: kNav_Height)).withRenderingMode(.alwaysOriginal)
